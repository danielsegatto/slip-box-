...
const STYLES = {
  ...
  textarea: "w-full border-gray-200 p-4 text-2xl bg-white resize-none min-h-[140px] placeholder:text-gray-200 leading-relaxed bg-transparent focus:outline-none",
